...
class OrgPostFormNotifier extends _ {
  @override
  OrgPostFormState build() => OrgPostFormState(startsAt: DateTime.now().add(const Duration(days: 7)));
  ...
  void setSubmitting(bool v) => state = state.copyWith(isSubmitting: v, hasError: false);
  void setError() => state = state.copyWith(hasError: true, isSubmitting: false);
}
