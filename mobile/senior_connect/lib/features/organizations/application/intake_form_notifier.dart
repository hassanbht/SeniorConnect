...
class IntakeFormNotifier extends _ {
  ...
  Future<void> _load(
    ...
    try {
      ...
      state = state.copyWith(isLoading: false, loadErrorKey: 'errors.generic');
    }
  }

  void setCriminalClearance(bool v) =>
      state = state.copyWith(criminalClearance: v);
  ...
  void setSubmitting(bool v) =>
      state = state.copyWith(isSubmitting: v, submitErrorKey: null);
  void setSubmitError(String key) =>
      state = state.copyWith(submitErrorKey: key, isSubmitting: false);
