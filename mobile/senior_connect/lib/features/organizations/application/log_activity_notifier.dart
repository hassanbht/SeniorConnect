...
class LogActivityNotifier extends _ {
  ...
  void setInsuranceContext(int c) =>
      state = state.copyWith(insuranceContext: c);
  void setTransportMode(int m) => state = state.copyWith(transportMode: m);
  void setSubmitting(bool v) =>
      state = state.copyWith(isSubmitting: v, errorMessage: null);
  void setError(String msg) =>
      state = state.copyWith(errorMessage: msg, isSubmitting: false);
  void prefill(String catKey, int duration) => state = state.copyWith(
