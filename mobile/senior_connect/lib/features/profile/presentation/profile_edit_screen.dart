...
class _ProfileEditScreenState extends State<ProfileEditScreen> {
  ...
  Future<void> _requestPhoneVerification() async {
    ...
    // TODO P1-28: call AuthRepository.requestProfilePhoneVerification
    await Future.delayed(const Duration(seconds: 1));
    if (mounted) {
      setState(() => _isVerifyingPhone = false);
      // Navigate to OTP verification screen
      context.go('${AppRoutes.otpVerify}?phone=${Uri.encodeComponent(_phoneController.text.trim())}&purpose=phone_verification');
    }
  }

  Future<void> _verifyPhoneOtp(String code) async {
    // TODO P1-28: call AuthRepository.verifyProfilePhone
    setState(() {
      _phoneVerified = true;
    });
  }
