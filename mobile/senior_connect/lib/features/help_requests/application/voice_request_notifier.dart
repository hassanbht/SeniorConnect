...
class VoiceRequestNotifier extends _ {
  static const _emergency = ['notfall','schmerz','herz','sturz','blut','atemnot','144','112','emergency'];
  static const _nursing = ['spritze','medikament dosieren','verband wechseln','infusion','katheter'];
  @override
  ...
  void toggleListening() {
    ...
    if (listening) {
      ...
      state = state.copyWith(isListening: true, currentTranscript: t,
