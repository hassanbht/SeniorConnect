...
namespace SeniorConnect.Infrastructure.Migrations
{
    ...
    [Migration("20260919081014_AddPerformanceAndLookupIndexes")]
    partial class AddPerformanceAndLookupIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SeniorConnect.Modules.Community.Domain.CommunityEventOccurrenceCancellation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EventOccurrenceCancellations", "public");
                });
            ...
            modelBuilder.Entity("SeniorConnect.Modules.Family.Domain.FamilyRelationship", b =>
                {
                    ...
                    b.HasIndex("CaregiverUserId", "Status")
                        .HasDatabaseName("ix_family_relationships_caregiver_status");

                    b.HasIndex("SeniorUserId", "Status")
            ...
            modelBuilder.Entity("SeniorConnect.Modules.Family.Domain.SeniorAccessLog", b =>
                {
                    ...
                    b.HasIndex("SeniorUserId", "TimestampUtc")
            ...
            modelBuilder.Entity("SeniorConnect.Modules.Family.Domain.TrustedContact", b =>
                {
                    ...
                    b.HasIndex("SeniorUserId", "IsDeleted")
            ...
            modelBuilder.Entity("SeniorConnect.Modules.Geography.Domain.AustrianAdministrativeUnit", b =>
                {
                    ...
                    b.HasIndex("BezirkCode")
                        .HasDatabaseName("ix_austria_bezirk");

                    b.HasIndex("BundeslandCode")
                        .HasDatabaseName("ix_austria_bundesland");

                    b.HasIndex("GemeindeName")
                        .HasDatabaseName("ix_austria_geo_gemeinde");

                    b.HasIndex("PostalCode")
                        .HasDatabaseName("ix_austria_geo_plz");

                    b.HasIndex("Latitude", "Longitude")
                        .HasDatabaseName("ix_austria_geo_coords");
            ...
            modelBuilder.Entity("SeniorConnect.Modules.HelpRequests.Domain.HelpRequest", b =>
                {
                    ...
                    b.Property<string>("NoShowDisputeReason")
                        .HasColumnType("text");

                    b.Property<DateTimeOffset?>("NoShowDisputedAtUtc")
                        .HasColumnType("timestamptz");

                    b.Property<Guid?>("NoShowDisputedByUserId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AssignedVolunteerUserId", "Status")
            ...
            modelBuilder.Entity("SeniorConnect.Modules.HelpRequests.Domain.HelpRequestStatusHistory", b =>
                {
                    ...
                    b.HasIndex("HelpRequestId", "ChangedAtUtc")
            ...
            modelBuilder.Entity("SeniorConnect.Modules.Reporting.Domain.DataProcessingAgreement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ControllerRole")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("controller_role");

                    b.Property<string>("CounterpartyContactEmail")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("counterparty_contact_email");

                    b.Property<string>("CounterpartyContactName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("counterparty_contact_name");
                    ...
                    b.HasIndex("OrganizationId")
                        .HasDatabaseName("ix_dpa_organization_id");

                    b.ToTable("data_processing_agreements", "public", t =>
                        {
                            t.HasCheckConstraint("ck_dpa_controller_role", "controller_role IN ('PlatformIsController','PlatformIsProcessor','JointController')");

                            t.HasCheckConstraint("ck_dpa_status", "status IN ('Draft','Sent','Executed','Expired')");
                        });
                });

            modelBuilder.Entity("SeniorConnect.Modules.Reporting.Domain.DpiaRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("AffectedVulnerableGroups")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("affected_vulnerable_groups");
                    ...
                    b.Property<DateTimeOffset?>("ConductedAtUtc")
                        .HasColumnType("timestamptz")
                        .HasColumnName("conducted_at_utc");

                    b.Property<string>("ConductedByName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("conducted_by_name");
                    ...
                    b.Property<string>("MitigationMeasures")
                        ...
                        .HasColumnName("mitigation_measures");

                    b.Property<DateTimeOffset?>("ReviewDueUtc")
                        .HasColumnType("timestamptz")
                        .HasColumnName("review_due_utc");
                    ...
                    b.ToTable("dpia_records", "public", t =>
                        {
                            t.HasCheckConstraint("ck_dpia_approval_status", "approval_status IN ('NotStarted','Draft','UnderReview','Approved')");
                        });
                });
            ...
            modelBuilder.Entity("SeniorConnect.Modules.Reporting.Domain.HostingAttestation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTimeOffset?>("ContractSignedAtUtc")
                        .HasColumnType("timestamptz")
                        .HasColumnName("contract_signed_at_utc");
                    ...
                    b.Property<string>("DataCenterRegion")
                        ...
                        .HasColumnName("data_center_region");

                    b.Property<string>("DpaWithProviderReference")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("dpa_with_provider_reference");

                    b.Property<string>("HostingProviderName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("hosting_provider_name");
                    ...
                    b.ToTable("hosting_attestations", "public");
                });

            modelBuilder.Entity("SeniorConnect.Modules.Reporting.Domain.InsurancePolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTimeOffset?>("CoverageEndUtc")
                        .HasColumnType("timestamptz")
                        .HasColumnName("coverage_end_utc");

                    b.Property<DateTimeOffset?>("CoverageStartUtc")
                        .HasColumnType("timestamptz")
                        .HasColumnName("coverage_start_utc");

                    b.Property<string>("CoverageSummary")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)")
                        .HasColumnName("coverage_summary");
                    ...
                    b.Property<DateTimeOffset?>("WrittenConfirmationReceivedAtUtc")
                        .HasColumnType("timestamptz")
                        .HasColumnName("written_confirmation_received_at_utc");

                    b.HasKey("Id");

                    b.HasIndex("OrganizationId", "PolicyType")
                        .HasDatabaseName("ix_insurance_policy_org_type");

                    b.ToTable("insurance_policies", "public", t =>
                        {
                            t.HasCheckConstraint("ck_insurance_policy_type", "policy_type IN ('VolunteerAccident','TransportLiability','GeneralLiability')");
                        });
                });

            modelBuilder.Entity("SeniorConnect.Modules.Reporting.Domain.LegalEntityProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTimeOffset?>("EstablishedAtUtc")
                        .HasColumnType("timestamptz")
                        .HasColumnName("established_at_utc");
                    ...
                    b.Property<DateTimeOffset?>("PrivacyPolicyLawyerReviewedAtUtc")
                        .HasColumnType("timestamptz")
                        .HasColumnName("privacy_policy_lawyer_reviewed_at_utc");
                    ...
                    b.Property<DateTimeOffset?>("TermsLawyerReviewedAtUtc")
                        .HasColumnType("timestamptz")
                        .HasColumnName("terms_lawyer_reviewed_at_utc");
                    ...
                    b.ToTable("legal_entity_profiles", "public");
                });

            modelBuilder.Entity("SeniorConnect.Modules.Reporting.Domain.ProcessingActivityRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("DataSubjectCategories")
                        ...
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("data_subject_categories");

                    b.Property<bool>("InvolvesThirdCountryTransfer")
                        .HasColumnType("boolean")
                        .HasColumnName("involves_third_country_transfer");
                    ...
                    b.Property<string>("RecipientCategories")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("recipient_categories");

                    b.Property<string>("RetentionPeriodDescription")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                    ...
                    b.ToTable("processing_activity_records", "public", t =>
                        {
                            t.HasCheckConstraint("ck_par_legal_basis", "legal_basis IN ('Consent','Contract','LegitimateInterest','LegalObligation','VitalInterest')");
                        });
                });
